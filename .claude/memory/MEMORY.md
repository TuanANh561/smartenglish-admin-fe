...
Giai đoạn 0–3 đã xong. Tiếp tục giai đoạn 4 trong `.claude/prompts/giai-doan-giao-dien.md` (bộ biểu đồ dùng chung bằng recharts — có thể dùng skill `dashboard-chart`). Giai đoạn 0–6 là nền dùng chung, không được bỏ qua.
