...
export const CLASS_STUDENTS = {
  ...
  'cls-5': [
    { id: 's15', name: 'Nguyễn Thanh Tùng', email: 'tung.nt@example.com', initials: 'NT', avatarColor: '#29A8E8', avgScore: 8.4, progress: 75, lastSeen: 'Hôm nay, 11:30 AM' },
    { id: 's16', name: 'Trần Bảo Ngọc', email: 'ngoc.tb@example.com', initials: 'BN', avatarColor: '#ec4899', avgScore: 7.9, progress: 60, lastSeen: '1 ngày trước' },
  ],
  'cls-6': [
    { id: 's17', name: 'Vũ Minh Trí', email: 'tri.vm@example.com', initials: 'MT', avatarColor: '#10b981', avgScore: 8.8, progress: 80, lastSeen: 'Hôm qua, 15:00 PM' },
    { id: 's18', name: 'Lê Thảo Vy', email: 'vy.lt@example.com', initials: 'TV', avatarColor: '#8b5cf6', avgScore: 7.1, progress: 50, lastSeen: '2 ngày trước' },
  ],
}
...
export const CLASSES = [
  ...
  },
  {
    ...
    teacherEmail: 'thang.vd@gmail.com',
